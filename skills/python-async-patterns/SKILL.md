...
description: |
  Python asyncio patterns for concurrent programming, async/await, and non-blocking I/O operations.
  WHEN: Building async APIs with FastAPI/aiohttp, implementing concurrent I/O operations, using asyncio.gather/create_task, rate limiting with semaphores, producer-consumer patterns.
  WHEN NOT: Synchronous Python code, CPU-bound tasks (use multiprocessing), general Python development without async.
---
...
- Developing in Python 3.7+ with asyncio and user asks to build async APIs or services
- Developing in Python 3.7+ with asyncio and user asks to implement concurrent I/O-bound applications
- Developing in Python 3.7+ with asyncio and user asks to optimize performance with non-blocking operations
- Developing in Python 3.7+ with asyncio and user asks to build async web APIs (FastAPI, aiohttp, Sanic)
- Developing in Python 3.7+ with asyncio and user asks to implement concurrent I/O operations (database, file, network)
